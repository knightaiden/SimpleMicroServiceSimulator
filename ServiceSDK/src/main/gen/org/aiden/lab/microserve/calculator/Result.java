...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
  ...
  private static final org.apache.thrift.protocol.TField RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("result", org.apache.thrift.protocol.TType.DOUBLE, (short)1);
  private static final org.apache.thrift.protocol.TField IS_CORRECT_FIELD_DESC = new org.apache.thrift.protocol.TField("isCorrect", org.apache.thrift.protocol.TType.BOOL, (short)2);
  ...
  public boolean isCorrect; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    RESULT((short)1, "result"),
    IS_CORRECT((short)2, "isCorrect");
  ...
  private static final int __ISCORRECT_ISSET_ID = 1;
  ...
  public Result setResult(double result) {
    this.result = result;
    setResultIsSet(true);
    return this;
  }
  ...
  public Result setIsCorrect(boolean isCorrect) {
    this.isCorrect = isCorrect;
    setIsCorrectIsSet(true);
    return this;
  }
  ...
  public void unsetIsCorrect() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISCORRECT_ISSET_ID);
  }

  /** Returns true if field isCorrect is set (has been assigned a value) and false otherwise */
  public boolean isSetIsCorrect() {
    return EncodingUtils.testBit(__isset_bitfield, __ISCORRECT_ISSET_ID);
  }

  public void setIsCorrectIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISCORRECT_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_isCorrect = true;
    list.add(present_isCorrect);
    if (present_isCorrect)
      list.add(isCorrect);
  ...
  public int compareTo(Result other) {
    ...
    lastComparison = Boolean.valueOf(isSetIsCorrect()).compareTo(other.isSetIsCorrect());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsCorrect()) {
  ...
  private static class ResultStandardScheme extends StandardScheme<Result> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // IS_CORRECT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isCorrect = iprot.readBool();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Result struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBool(struct.isCorrect);
      oprot.writeFieldEnd();
